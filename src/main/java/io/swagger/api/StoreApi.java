...
public interface StoreApi {
    ...
    ResponseEntity<List> getRestaurant();
    ...
    @RequestMapping(value = "/store/location",
            produces = { "application/json" },
            method = RequestMethod.GET)
    ResponseEntity<List> getRestaurantWithlocation(@NotNull @ApiParam(value = "filterByLocation", required = true) @Valid @RequestParam(value = "filterByLocation", required = true) String filterByLocation);
